...
void line_follow_task(void* arg)
{
    ...
    while(true)
    {
        ...
        if(line_sensor_readings.adc_reading[0]>=600 && line_sensor_readings.adc_reading[1] >=600  && line_sensor_readings.adc_reading[2]>=600  )
        {
        ...
        // else if(line_sensor_readings.adc_reading[0]<=300 && line_sensor_readings.adc_reading[1] >=600  && line_sensor_readings.adc_reading[2]>=600 && line_sensor_readings.adc_reading[3]>=600 )
        // {
...
void black_follow(void* arg)
{
    ...
    while(true)
    {
        ...
        while(line_sensor_readings.adc_reading[0]>=600 && line_sensor_readings.adc_reading[1] <=300  && line_sensor_readings.adc_reading[2]<=300 && line_sensor_readings.adc_reading[3]>=600)
        {
        //Colour Blind
...
void app_main()
{
    ...
    xTaskCreate(&black_follow, "Black_follow", 4096, NULL, 1, NULL);
